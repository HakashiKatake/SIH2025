export declare const createRedisClient: () => import("@redis/client").RedisClientType<{
    json: {
        ARRAPPEND: {
...
export declare class WeatherCacheService extends CacheService {
    private readonly WEATHER_TTL;
    private readonly FORECAST_TTL;
    private readonly ALERT_TTL;
    getWeatherData(locationKey: string): Promise<any>;
    setWeatherData(locationKey: string, data: any, ttl?: number): Promise<boolean>;
    getForecastData(locationKey: string): Promise<any>;
    setForecastData(locationKey: string, data: any): Promise<boolean>;
    getUserAlerts(userId: string): Promise<any>;
    setUserAlerts(userId: string, alerts: any): Promise<boolean>;
    invalidateWeatherCache(locationKey: string): Promise<void>;
    invalidateUserAlerts(userId: string): Promise<void>;
}
export declare class UserCacheService extends CacheService {
    private readonly USER_PROFILE_TTL;
    private readonly USER_PREFERENCES_TTL;
    getUserProfile(userId: string): Promise<any>;
    setUserProfile(userId: string, profile: any): Promise<boolean>;
    getUserPreferences(userId: string): Promise<any>;
    setUserPreferences(userId: string, preferences: any): Promise<boolean>;
    invalidateUserCache(userId: string): Promise<void>;
}
export declare class MarketplaceCacheService extends CacheService {
    private readonly PRODUCT_LIST_TTL;
    private readonly SEARCH_RESULTS_TTL;
    getProductsByLocation(state: string, district?: string): Promise<any>;
    setProductsByLocation(state: string, products: any, district?: string): Promise<boolean>;
    getSearchResults(searchTerm: string, filters?: any): Promise<any>;
    setSearchResults(searchTerm: string, results: any, filters?: any): Promise<boolean>;
    invalidateProductCache(sellerId?: string): Promise<void>;
}
export declare const cache: CacheService;
export declare const weatherCache: WeatherCacheService;
export declare const userCache: UserCacheService;
export declare const marketplaceCache: MarketplaceCacheService;
